...
-- Source: /Users/atahan/Library/Application Support/AddressBook/Sources/8F026174-9938-478B-B313-1FD89998D118/AddressBook-v22.abcddb
-- Contact count: 994
-- Regenerate empty DB: fixtures/contacts/create-empty-db.sh
CREATE TABLE ZABCDADDRESSINGGRAMMAR (
...
CREATE TABLE ZABCDCUSTOMPROPERTY (
  Z_PK INTEGER PRIMARY KEY,
  Z_ENT INTEGER,
  Z_OPT INTEGER,
  ZVALUETYPE INTEGER,
...
CREATE TABLE ZABCDCUSTOMPROPERTYVALUE (
  Z_PK INTEGER PRIMARY KEY,
  Z_ENT INTEGER,
  Z_OPT INTEGER,
...
CREATE TABLE ZABCDDISTRIBUTIONLISTCONFIG (
  Z_PK INTEGER PRIMARY KEY,
  Z_ENT INTEGER,
  Z_OPT INTEGER,
  ZADDRESS INTEGER,
...
CREATE TABLE ZABCDRECORD (
  ...
  ZIMAGESYNCFAILEDTIME TIMESTAMP,
  ZWALLPAPERSYNCFAILEDTIME TIMESTAMP,
...
CREATE TABLE ZABCDREMOTELOCATION (
  Z_PK INTEGER PRIMARY KEY,
  Z_ENT INTEGER,
  Z_OPT INTEGER,
  ZISPRIMARY INTEGER,
...
CREATE TABLE ZABCDUNKNOWNPROPERTY (
  Z_PK INTEGER PRIMARY KEY,
  Z_ENT INTEGER,
  Z_OPT INTEGER,
  ZOWNER INTEGER,
...
CREATE TABLE ZCNCDCHANGEHISTORYCLIENT (
  Z_PK INTEGER PRIMARY KEY,
  Z_ENT INTEGER,
  Z_OPT INTEGER,
...
CREATE TABLE ZCNCDPROVIDERMETADATA (
  Z_PK INTEGER PRIMARY KEY,
  Z_ENT INTEGER,
  Z_OPT INTEGER,
  ZVERSION INTEGER,
...
CREATE TABLE ZCNCDUNIFIEDCONTACTINFO (
  Z_PK INTEGER PRIMARY KEY,
  Z_ENT INTEGER,
  Z_OPT INTEGER,
...
CREATE UNIQUE INDEX Z_ABCDCustomProperty_UNIQUE_propertyName_recordType ON ZABCDCUSTOMPROPERTY (
  ZPROPERTYNAME COLLATE BINARY ASC,
  ZRECORDTYPE COLLATE BINARY ASC
);
