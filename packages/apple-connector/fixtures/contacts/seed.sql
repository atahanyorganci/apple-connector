...
INSERT INTO
  ZABCDRECORD (Z_PK, Z_ENT, Z_OPT, ZTYPE, ZUNIQUEID, ZNAME)
VALUES
  (
    1,
    25,
...
-- Group
INSERT INTO
  ZABCDRECORD (Z_PK, Z_ENT, Z_OPT, ZCONTAINER, ZNAME, ZUNIQUEID)
VALUES
  (
    2,
    19,
...
VALUES
  (
    ...
    '+15551234567',
    '_$!<Mobile>!$_',
    'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb:ABPhoneNumber',
    0
  );
...
VALUES
  (
    ...
    '_$!<Work>!$_',
    'cccccccc-cccc-cccc-cccc-cccccccccccc:ABEmailAddress',
    0
  );

-- Note
INSERT INTO
  ZABCDNOTE (Z_PK, Z_ENT, Z_OPT, ZCONTACT, ZTEXT)
VALUES
  (1, 14, 1, 3, 'Fixture contact note');

-- Contact index for search
INSERT INTO
  ZABCDCONTACTINDEX (Z_PK, Z_ENT, Z_OPT, ZCONTACT, ZSTRINGFORINDEXING)
VALUES
  (1, 5, 1, 3, 'Jane Doe');
