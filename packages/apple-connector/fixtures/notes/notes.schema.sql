...
CREATE TABLE ZICASSETSIGNATURE (
  Z_PK INTEGER PRIMARY KEY,
  Z_ENT INTEGER,
  Z_OPT INTEGER,
  ZISUSERSPECIFICRECORDKEY INTEGER,
  ZCLOUDSYNCINGOBJECT INTEGER,
  Z3_CLOUDSYNCINGOBJECT INTEGER,
  ZCLOUDKITRECORDKEY VARCHAR,
  ZFETCHEDLOCALASSETSIGNATUREHASH VARCHAR,
  ZLASTKNOWNSERVERASSETSIGNATUREHASH VARCHAR
);
...
CREATE TABLE ZICCLOUDSYNCINGOBJECT (
  ...
  ZHASMISSINGKEYCHAINITEM INTEGER,
  ...
  ZNEEDSTOFETCHUSERSPECIFICRECORDASSETS INTEGER,
  ZNEEDSTOSAVEUSERSPECIFICRECORD INTEGER,
  ZNEEDSTOUPDATEUSERSPECIFICRECORDREFERENCEACTIONS INTEGER,
  ZCLOUDSTATE INTEGER,
  ZINVITATION INTEGER,
  ZLOCKEDNOTESMODE INTEGER,
  ZSUPPORTSV1NEO INTEGER,
  ZACCOUNT INTEGER,
  ZCHECKEDFORLOCATION INTEGER,
  ZDIDRUNPAPERFORMDETECTION INTEGER,
  ZFILESIZE INTEGER,
  ZHANDWRITINGSUMMARYVERSION INTEGER,
  ZHASMARKUPDATA INTEGER,
  ZHASPAPERFORM INTEGER,
  ZIMAGECLASSIFICATIONSUMMARYVERSION INTEGER,
  ZIMAGEFILTERTYPE INTEGER,
  ZNEEDSINITIALRELATIONSHIPSETUP INTEGER,
  ZNEEDSTRANSCRIPTION INTEGER,
  ZOCRSUMMARYVERSION INTEGER,
  ...
  ZACCOUNT2 INTEGER,
  ZACCOUNT3 INTEGER,
  ZMENTIONNOTIFICATIONATTEMPTCOUNT INTEGER,
  ZMENTIONNOTIFICATIONSTATE INTEGER,
  ZACCOUNT4 INTEGER,
  ZNOTE1 INTEGER,
  ZPARENTATTACHMENT1 INTEGER,
  ZTYPE INTEGER,
  ZACCOUNT5 INTEGER,
  ZACCOUNT6 INTEGER,
  ...
  ZHASCHECKLISTINPROGRESS INTEGER,
  ZHASEMPHASIS INTEGER,
  ZHASSYSTEMTEXTATTACHMENTS INTEGER,
  ZISPINNED INTEGER,
  ZISSYSTEMPAPER INTEGER,
  ZLEGACYNOTEWASPLAINTEXT INTEGER,
  ZNOTEHASCHANGES INTEGER,
  ZPAPERSTYLETYPE INTEGER,
  ZPREFERREDBACKGROUNDTYPE INTEGER,
  ZACCOUNT7 INTEGER,
  ZFOLDER INTEGER,
  ZNOTEDATA INTEGER,
  ZTITLESOURCEATTACHMENT INTEGER,
  ZDATEHEADERSTYPE INTEGER,
  ...
  ZSERVERSIDEUPDATETASKFAILURECOUNT INTEGER,
  ZSTOREDATASEPARATELY INTEGER,
  ...
  ZLASTATTRIBUTIONSVIEWEDDATE TIMESTAMP,
  ...
  ZFALLBACKPDFGENERATION VARCHAR,
  ZFALLBACKSUBTITLEIOS VARCHAR,
  ZFALLBACKSUBTITLEMAC VARCHAR,
  ZFALLBACKTITLE VARCHAR,
  ZHANDWRITINGSUMMARY VARCHAR,
  ZIMAGECLASSIFICATIONSUMMARY VARCHAR,
  ZOCRSUMMARY VARCHAR,
  ZPAPERBUNDLEGENERATION VARCHAR,
  ...
  ZFILENAME VARCHAR,
  ZGENERATION1 VARCHAR,
  ZHOSTAPPLICATIONIDENTIFIER VARCHAR,
  ...
  ZTITLE2 VARCHAR,
  ZATTRIBUTEDSNIPPET BLOB,
  ZATTRIBUTEDTITLE BLOB,
  ZREPLICAIDTOBUNDLEIDENTIFIER BLOB,
...
CREATE TABLE ZICINVITATION (
  ...
  ZSHAREURL VARCHAR,
  ZSERVERSHAREDATA BLOB,
  ZTHUMBNAILDATADARK BLOB,
  ZTHUMBNAILDATALIGHT BLOB
);
