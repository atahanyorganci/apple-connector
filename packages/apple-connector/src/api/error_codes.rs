...
impl ErrorCode {
    ...
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::AmbiguousEventKitMatch => "ambiguous_eventkit_match",
...
mod tests {
    ...
    fn all_codes() -> Vec<ErrorCode> {
        vec![
            ...
            ErrorCode::ByteRangeNotSatisfiable,
            ErrorCode::MessagesDatabaseUnavailable,
            ErrorCode::RemindersDatabaseUnavailable,
            ErrorCode::NotesDatabaseUnavailable,
            ErrorCode::CalendarDatabaseUnavailable,
            ErrorCode::ContactsDatabaseUnavailable,
            ...
            ErrorCode::NoteAttachmentUnavailable,
            ErrorCode::ReminderNotFound,
            ErrorCode::ReminderListNotFound,
            ErrorCode::ReminderAttachmentNotFound,
            ErrorCode::ReminderAttachmentUnavailable,
            ErrorCode::SmartListReadOnly,
            ErrorCode::UnsupportedReminderField,
            ErrorCode::CalendarNotFound,
            ErrorCode::CalendarAccountNotFound,
            ErrorCode::EventNotFound,
            ErrorCode::EventAttachmentNotFound,
            ErrorCode::EventAttachmentUnavailable,
            ErrorCode::EventEndBeforeStart,
            ErrorCode::UnsupportedAlarmKind,
            ErrorCode::AmbiguousEventKitMatch,
            ErrorCode::ContactNotFound,
            ErrorCode::GroupNotFound,
            ErrorCode::ContainerNotFound,
            ErrorCode::ContactPhotoNotFound,
            ErrorCode::ReadOnlyContainer,
            ErrorCode::EventkitAccessDenied,
            ErrorCode::ContactsAccessDenied,
            ErrorCode::EventkitUnavailable,
            ErrorCode::ContactsUnavailable,
            ErrorCode::CalendarReadOnly,
            ErrorCode::SqliteSyncPending,
